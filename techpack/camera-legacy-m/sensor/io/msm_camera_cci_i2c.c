...
int32_t legacy_m_msm_camera_cci_i2c_read(struct msm_camera_i2c_client *client,
...
int32_t legacy_m_msm_camera_cci_i2c_read_seq(struct msm_camera_i2c_client *client,
...
int32_t legacy_m_msm_camera_cci_i2c_write(struct msm_camera_i2c_client *client,
	uint32_t addr, uint16_t data,
	enum msm_camera_i2c_data_type data_type)
{
	int32_t rc = -EFAULT;
...
int32_t legacy_m_msm_camera_cci_i2c_write_seq(struct msm_camera_i2c_client *client,
	uint32_t addr, uint8_t *data, uint32_t num_byte)
{
	int32_t rc = -EFAULT;
	uint32_t i = 0;
...
int32_t legacy_m_msm_camera_cci_i2c_write_table_async(
	struct msm_camera_i2c_client *client,
	struct msm_camera_i2c_reg_setting *write_setting)
{
...
int32_t legacy_m_msm_camera_cci_i2c_write_table_sync(
	struct msm_camera_i2c_client *client,
	struct msm_camera_i2c_reg_setting *write_setting)
{
	return msm_camera_cci_i2c_write_table_cmd(client, write_setting,
...
int32_t legacy_m_msm_camera_cci_i2c_write_table_sync_block(
	struct msm_camera_i2c_client *client,
	struct msm_camera_i2c_reg_setting *write_setting)
{
	return msm_camera_cci_i2c_write_table_cmd(client, write_setting,
...
int32_t legacy_m_msm_camera_cci_i2c_write_table(
	struct msm_camera_i2c_client *client,
	struct msm_camera_i2c_reg_setting *write_setting)
{
	return msm_camera_cci_i2c_write_table_cmd(client, write_setting,
...
int32_t legacy_m_msm_camera_cci_i2c_write_seq_table(
	struct msm_camera_i2c_client *client,
	struct msm_camera_i2c_seq_reg_setting *write_setting)
{
	...
	for (i = 0; i < write_setting->size; i++) {
		rc = legacy_m_msm_camera_cci_i2c_write_seq(client, reg_setting->reg_addr,
...
int32_t legacy_m_msm_camera_cci_i2c_write_table_w_microdelay(
	struct msm_camera_i2c_client *client,
	struct msm_camera_i2c_reg_setting *write_setting)
{
	int32_t rc = -EFAULT;
	...
	enum msm_camera_i2c_data_type data_type)
{
	...
	rc = legacy_m_msm_camera_cci_i2c_read(client, addr, &reg_data, data_len);
	if (rc < 0)
		return rc;
...
int32_t legacy_m_msm_camera_cci_i2c_poll(struct msm_camera_i2c_client *client,
	uint32_t addr, uint16_t data,
	...
	enum msm_camera_i2c_data_type data_type, uint16_t set_mask)
{
	...
	rc = legacy_m_msm_camera_cci_i2c_read(client, addr, &reg_data, data_type);
	if (rc < 0) {
	...
	rc = legacy_m_msm_camera_cci_i2c_write(client, addr, reg_data, data_type);
	if (rc < 0)
	...
	enum msm_camera_i2c_data_type data_type)
{
	...
	if (mask == -1)
		return 0;
	if (mask == 0) {
		rc = legacy_m_msm_camera_cci_i2c_write(client, addr, data, data_type);
	} else {
		rc = legacy_m_msm_camera_cci_i2c_read(client, addr, &reg_data,
			data_type);
		if (rc < 0) {
			CDBG("%s read fail\n", __func__);
			return rc;
		...
		reg_data &= ~mask;
		reg_data |= (data & mask);
		rc = legacy_m_msm_camera_cci_i2c_write(client, addr, reg_data,
			data_type);
		if (rc < 0)
			CDBG("%s write fail\n", __func__);
	}
...
int32_t legacy_m_msm_camera_cci_i2c_write_conf_tbl(
	struct msm_camera_i2c_client *client,
	...
	enum msm_camera_i2c_data_type data_type)
{
	...
	for (i = 0; i < size; i++) {
		...
		if (reg_conf_tbl->cmd_type == MSM_CAMERA_I2C_CMD_POLL) {
			rc = legacy_m_msm_camera_cci_i2c_poll(client,
			...
			case MSM_CAMERA_I2C_BYTE_DATA:
			case MSM_CAMERA_I2C_WORD_DATA:
				rc = legacy_m_msm_camera_cci_i2c_write(
					client,
					reg_conf_tbl->reg_addr,
...
int32_t legacy_m_msm_sensor_cci_i2c_util(struct msm_camera_i2c_client *client,
	uint16_t cci_cmd)
{
	int32_t rc = 0;
	struct msm_camera_cci_ctrl cci_ctrl;
