...
#define CHAR_DEVICE_NAME "rem"
#define DEVICE_CLASS_NAME "remdev"
#define DEV_NUMBER 1
...
static struct remotepanel_data *remote_free_panel_data_s1302(struct remotepanel_data *pdata);
...
static void rmidev_device_cleanup(struct rmidev_data *dev_data)
{
	...
	if (dev_data) {
		...
		remote_free_panel_data_s1302(dev_data->pdata);
